...
int main (int argc, char **argv)
{
  ...
  // UNDER_METHOD HaruPDF (constructor)
    HPDF_Doc  pdf;
    HPDF_Page page;
    char fname[256];
    HPDF_Font font;
    float angle2; // DO NOT INCLUDE
    float rad1; // DO NOT INCLUDE
    float rad2;  // DO NOT INCLUDE
    unsigned int i; // DO NOT INCLUDE
...
//    print_grid  (pdf, page);
    ...
    // XX_UNDER_METHOD HaruPDF


    // UNDER_METHOD beginWrite()
    ...
    // XX_UNDER_METHOD beginWrite()



    // UNDER_METHOD printCharAtPosition
    ...
    for (i = 0; i < strlen (SAMP_TXT); i++) {
        ...
        HPDF_Page_SetTextMatrix(page,
                                ...
                                x, y);                                            // UNDER_METHOD printCharAtPosition

        // C-style strings are null-terminated. The last character must a 0.
        buf[0] = SAMP_TXT[i]; // The character to display                         // UNDER_METHOD printCharAtPosition
        buf[1] = 0;                                                               // UNDER_METHOD printCharAtPosition
        HPDF_Page_ShowText (page, buf);                                           // UNDER_METHOD printCharAtPosition
        angle2 -= 10.0; // change the angle around the circle
    }



    //  UNDER_METHOD endWrite()
    HPDF_Page_EndText (page);


    // UNDER_METHOD saveToFile
